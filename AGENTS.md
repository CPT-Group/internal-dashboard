...
- **Dev Corner Two (RIGHT TV)** — **Company-facing**. Visible to non-dev employees. **5-slide** carousel with **per-slide dwell** (`SLIDE_DURATIONS_MS` in `DevCornerTwoDashboard.tsx`): **25s** for slides 1–4; **300s** (5 min) for slide 5 (GitHub deploy):
