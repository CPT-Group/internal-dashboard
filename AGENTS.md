...
- **Dev Corner One (LEFT TV)** — **Developer-focused**. Closest to the dev desks. Single-view layout:
  ...
  - Bottom: NOVA Team Activity panel (`NOVA_CORE_DEVS` cards — Roy, Kyle, James, Brandon — with in-progress + To Do ticket chips).
...
- Dev Corner One **Team Activity**: in-progress chips bucket by **assignee** (not Tech Owner); **To Do** chips render **after** in-progress chips via `--team-activity-todo-*` tokens — differs from Dev Corner Two in-progress cards (Tech Owner).
