...
const WORKFLOW_GH_NAMES: Readonly<Record<number, string>> = {
  ...
  301140620: 'TST Auto-Merge (development -> test)',
  301143101: 'TST Auto-Merge (development -> test)',
  301118082: 'TST Auto-Merge (development -> test)',
  301718893: 'TST Auto-Merge (development -> test)',
