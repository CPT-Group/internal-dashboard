/**
 * Build-time script: reads public/backgrounds/jackies-cute-backgrounds/ and writes
 * src/constants/jackiesBackgroundSlides.generated.ts for Jackie's Office dashboard
...
const FOLDER = path.join(ROOT, 'public', 'backgrounds', 'jackies-cute-backgrounds');
const OUT_FILE = path.join(ROOT, 'src', 'constants', 'jackiesBackgroundSlides.generated.ts');

const BASE_URL = '/backgrounds/jackies-cute-backgrounds';
...
const content = `/** Auto-generated from public/backgrounds/jackies-cute-backgrounds/ – do not edit manually */\n\nexport const JACKIES_BACKGROUND_SLIDES = [\n${slides.map((s) => `  '${s}',`).join('\n')}\n] as const;\n`;
