...
- **Dev Corner Two KPI deduplication**: Removed "Open" from Dev 2 KPI strip (was redundant with Dev 1 since TVs are side-by-side). Replaced with "Oldest" (oldest ticket age with severity coloring). Dev 1: Open, Landed Today, Closed Today, Net, Avg Close, Throughput. Dev 2: In Progress, Completed (7d), Requested, Avg Age, Oldest.
